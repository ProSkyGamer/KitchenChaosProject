...
public class PlatesCounterVisual : MonoBehaviour
{
    ...
    private void PlatesCounter_OnPlateSpawned(object sender, System.EventArgs e)
    {
        ...
        plateVisualTranform.localPosition = new Vector3(0f, plateOffsetY * platesVisualGameObjectList.Count, 0f);

        platesVisualGameObjectList.Add(plateVisualTranform.gameObject);
    }
}
